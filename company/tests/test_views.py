...
def test_collaboration_invite_create(authed_client, authed_supplier):
    ...
    assert response.json() == {
        ...
        'requestor_email': authed_supplier.company_email,
        'requestor_sso_id': authed_supplier.sso_id,
        'accepted_date': None,
        'role': data['role'],
        'accepted': False,
    }
    ...
    assert response.json() == [
        {
            ...
            'requestor_email': invite.company_user.company_email,
            'requestor_sso_id': invite.company_user.sso_id,
