    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_one', models.FileField(blank=True, null=True, upload_to=company.helpers.PathAndRename(sub_path='/supplier_case_study'))),
                ('image_two', models.FileField(blank=True, null=True, upload_to=company.helpers.PathAndRename(sub_path='/supplier_case_study'))),
                ('image_three', models.FileField(blank=True, null=True, upload_to=company.helpers.PathAndRename(sub_path='/supplier_case_study'))),
                ('video_one', models.FileField(blank=True, null=True, upload_to=company.helpers.PathAndRename(sub_path='/supplier_case_study'))),
