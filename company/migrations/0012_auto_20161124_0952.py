# -*- coding: utf-8 -*-
# Generated by Django 1.9.10 on 2016-11-24 09:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_one', models.FileField(blank=True, default='', null=True, upload_to=company.helpers.PathAndRename(sub_path='/supplier_case_study'), validators=[directory_validators.company.case_study_image_filesize])),
                ('image_two', models.FileField(blank=True, default='', null=True, upload_to=company.helpers.PathAndRename(sub_path='/supplier_case_study'), validators=[directory_validators.company.case_study_image_filesize])),
                ('image_three', models.FileField(blank=True, default='', null=True, upload_to=company.helpers.PathAndRename(sub_path='/supplier_case_study'), validators=[directory_validators.company.case_study_image_filesize])),
                ('video_one', models.FileField(blank=True, default='', null=True, upload_to=company.helpers.PathAndRename(sub_path='/supplier_case_study'), validators=[directory_validators.company.case_study_video_filesize])),
