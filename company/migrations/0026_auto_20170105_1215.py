...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='company',
            name='logo',
            field=models.FileField(blank=True, default='', upload_to=company.helpers.PathAndRename(sub_path='/company_logos')),
        ),
        migrations.AlterField(
            model_name='company',
            name='sectors',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, default=company.helpers.generate_verification_code, max_length=255, verbose_name='verification code'),
        ),
        migrations.AlterField(
            model_name='company',
            name='website',
