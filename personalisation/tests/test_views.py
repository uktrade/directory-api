...
@pytest.mark.django_db
def test_user_products_api_get(authed_client, authed_supplier):
...
def test_user_products_api_post(mock_create_or_update_product, authed_client, authed_supplier):
