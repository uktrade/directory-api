...
def test_notify_command_runs_functions_in_daily_type(mock_verify_code, mock_login):
...
@patch('notifications.notifications.verification_code_not_given')
@patch('notifications.notifications.new_companies_in_sector')
def test_notify_command_runs_functions_in_weekly_type(mock_verify_code, mock_login):
