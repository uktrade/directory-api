...
activity_stream_urls = [
    ...
    url(
        r'^exportplan-delivery-services/$',
        activitystream.views.ActivityStreamExportPlanDeliveryServicesViewSet.as_view({'get': 'list'}),
        name='activity-stream-export-plans-delivery-services',
    ),
]
