...
BGS_GOVNOTIFY_NEW_USER_INVITE_TEMPLATE_ID = env.bgs_govnotify_new_user_invite_template_id
GOVNOTIFY_NEW_USER_INVITE_OTHER_COMPANY_MEMBER_TEMPLATE_ID = (
    env.govnotify_new_user_invite_other_company_member_template_id
)
BGS_GOVNOTIFY_NEW_USER_INVITE_OTHER_COMPANY_MEMBER_TEMPLATE_ID = (
    env.bgs_govnotify_new_user_invite_other_company_member_template_id
)
...
BGS_GOV_NOTIFY_NON_CH_VERIFICATION_REQUEST_TEMPLATE_ID = env.bgs_gov_notify_non_ch_verification_request_template_id
GOV_NOTIFY_USER_REQUEST_DECLINED_TEMPLATE_ID = env.gov_notify_user_request_declined_template_id
BGS_GOV_NOTIFY_USER_REQUEST_DECLINED_TEMPLATE_ID = env.bgs_gov_notify_user_request_declined_template_id
...
BGS_GOVNOTIFY_NEW_COMPANIES_IN_SECTOR_TEMPLATE_ID = env.bgs_govnotify_new_companies_in_sector_template_id
...
BGS_GOVNOTIFY_VERIFICATION_CODE_NOT_GIVEN_TEMPLATE_ID = env.bgs_govnotify_verification_code_not_given_template_id
...
BGS_GOVNOTIFY_VERIFICATION_CODE_NOT_GIVEN_2ND_EMAIL_TEMPLATE_ID = (
    env.bgs_govnotify_verification_code_not_given_2nd_email_template_id
)
...
TRADE_UK_TOTALS_SA_FROM_S3_PREFIX = env.trade_uk_totals_sa_from_s3_prefix
