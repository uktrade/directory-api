...
def _expected_export_plan_response(export_plan):
    ...
    return {
        ...
        'object': {
            ...
            'created': created,
            'modified': modified,
            'answersCount': export_plan.answers_count,
            'ssoId': export_plan.sso_id,
            'companyId': export_plan.company.id,
            'exportCountries': export_plan.export_countries,
            'exportCommodityCodes': export_plan.export_commodity_codes,
