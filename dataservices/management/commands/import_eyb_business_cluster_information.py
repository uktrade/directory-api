...
from dataservices.management.commands.helpers import save_import_eyb_business_cluster_information_data
...
class Command(BaseCommand, S3DownloadMixin):
    ...
    def handle(self, *args, **options):
        self.do_handle(
            prefix=settings.EYB_BUSINESS_CLUSTER_INFORMATION_PREFIX,
            save_func=save_import_eyb_business_cluster_information_data,
        )
