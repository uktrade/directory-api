# Generated by Django 2.2.13 on 2021-01-07 15:23
...
def update_countries(apps, schema_editor):
    ...
    GDP = apps.get_model('dataservices', 'gdppercapita')
    Country = apps.get_model('dataservices', 'Country')
    for obj in GDP.objects.all():
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataservices', '0017_consumerpriceindex_country'),
    ]
