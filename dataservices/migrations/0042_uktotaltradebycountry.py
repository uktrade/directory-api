# Generated by Django 2.2.27 on 2022-04-11 10:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flow_type', models.CharField(choices=[('IMPORT', 'Import'), ('EXPORT', 'Export')], max_length=15)),
                ('product_type', models.CharField(choices=[('GOODS', 'Goods'), ('SERVICES', 'Services')], max_length=15)),
