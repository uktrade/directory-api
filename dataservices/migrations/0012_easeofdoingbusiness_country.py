# Generated by Django 2.2.13 on 2021-01-07 09:46
...
def update_countries(apps, schema_editor):
    ...
    EaseOfDoingBusiness = apps.get_model('dataservices', 'EaseOfDoingBusiness')
    Country = apps.get_model('dataservices', 'Country')
    for obj in EaseOfDoingBusiness.objects.all():
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataservices', '0011_suggestedcountry'),
    ]
